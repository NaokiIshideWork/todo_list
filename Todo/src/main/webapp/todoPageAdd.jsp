...
<body>
	...
	<form action="/Todo/ToDoAddServlet" method="post" id="form">
		<div class="card mx-auto mt-5 border-0" style="width: 55%;">
			<div class="mb-4 row">
				...
				<div class="col-sm-9 was-validated">
					<input type="text" id="txt" class="form-control border-primary" required
						maxlength="20" name="title" placeholder="タイトルは20文字以内です">
				</div>
			</div>
			<div class="mb-4 row">
				<label for="inputPassword" class="col-sm-2 col-form-label">優先度</label>
				<div class="col-sm-9 was-validated">
					<select class="form-control border-primary " name="priority" id="txt"
						required>
						<option>高</option>
						<option>中</option>
						<option>低</option>
			...
			<div class="mb-4 row">
				...
				<div class="col-sm-9 was-validated">
					<textarea class="form-control border-primary" name="contents"
						rows="2" id="txt" maxlength="100" required placeholder="100文字以内で入力してください"></textarea>
				</div>
			</div>
			<div class="col-sm-11 d-flex justify-content-end  ">
				...
				<input id="button" type="submit" class="btn btn-success" value="+追加"
					disabled />
			</div>
		</div>
	</form>
